...
const APP_CONFIG = {
  ...
  // Mix de l'échantillon carte : une part "articles les plus cités"
  // (signal fort-impact) + une part tirée au hasard parmi le reste (pour
  // capturer aussi les mots-clés fréquents globalement mais pas
  // spécialement concentrés dans le top par citations — ex.
  // "benchmark"/"dataset"). 0.5 = moitié/moitié. 0 = uniquement les plus
  // cités (comportement d'avant), 1 = uniquement aléatoire.
  RATIO_ALEATOIRE_CARTE_PAYS: 0.5,
